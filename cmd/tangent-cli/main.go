...
func printAdminUsage() {
	fmt.Println("tangent-cli admin export <character>")
	fmt.Println("tangent-cli admin register <json> [--force]")
	fmt.Println("tangent-cli admin batch-register <template> <colors>")
}
